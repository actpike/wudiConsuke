...
(async () => {
  ...
  console.log('=== localhost:4173 (Preview) 動作確認開始 ===');
  ...
  try {
    ...
    // スクリーンショット
    await page.screenshot({ path: 'localhost-4173-preview.png', fullPage: true });
    console.log('スクリーンショット保存: localhost-4173-preview.png');
